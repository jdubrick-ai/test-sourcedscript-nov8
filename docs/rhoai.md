...
3) Access the `workbench` named `test-sourcedscript-nov8-notebook`.
...
5) In the terminal, run `cd test-sourcedscript-nov8` to navigate to your sample app's directory.
